    ...
    <div className="p-8 md:p-12 text-black bg-[#f8f8f8] min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-12 md:gap-24">
        ...
        <main className="flex-1 max-w-2xl text-sm leading-relaxed space-y-6">
          <section>
            <h2 className="font-bold mb-6 text-lg">{t.statement.title}</h2>
            <p>{t.statement.p1}</p>
            <p className="mt-6">{t.statement.p2}</p>
            <p className="mt-6">{t.statement.p3}</p>
            <p className="mt-6">{t.statement.p4}</p>
            <p className="mt-6">{t.statement.p5}</p>
          </section>
        </main>
      </div>
    </div>
